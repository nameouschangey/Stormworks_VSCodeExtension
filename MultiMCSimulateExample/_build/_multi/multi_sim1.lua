require("_build._multi.simulate_multiple")
...
navigation.__simulator.config:addNumberHandler(2,
function(a) return loadingScreen.output._bools[11] and 1 or 0 end) -- once loadingScreen is done
navigation.onLBSimulatorShouldDraw = function (screenNumber) return screenNumber == 1 end


-- wait for loading screen to set output 11
--  and only connect to Monitor 1
menuLayout.__simulator.config:addNumberHandler(29,
function(a) return loadingScreen.output._bools[11] and 1 or 0 end
)
