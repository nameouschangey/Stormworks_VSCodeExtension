...
---@class LBParsingConstantsLoader : LBBaseClass
...
LBParsingConstantsLoader = {
    ...
    _mission_restricted_callbacks = {"onCreate", "onDestroy", "onCustomCommand", "onChatMessage",
    ...
    ---@param cls LBParsingConstantsLoader
    ---@return LBParsingConstantsLoader
    new = function(cls)
        ...
        this:addRestrictedKeywords(LBParsingConstantsLoader._default_restrictedKeywords)
        this:addBaseNames(LBParsingConstantsLoader._default_baseNames)
        return this
    end;

    loadNeloDocFile = function(this, filepath) -- 'Nelo Docs, with well formatted class definitions and function names ready to be plucked out
    ...
    addRestrictedKeywords = function(this, list)
        if(type(list) == "table") then
            local asDict = LBTable_select(list, function(v,k) return true,v end)
            LBTable_addRange(this.restrictedKeywords, asDict)
    ...
    _addFullName = function(this, item, instanceBased)
        instanceBased = instanceBased == nil or instanceBased
        local nameParts = LBString_split(item, ".")
...
LBClass(LBParsingConstantsLoader)