...
function onCustomCommand(full_message, user_peer_id, is_admin, is_auth, command, one, two, three, four, five)
    if command == "?set" then
        g_savedata.a = LifeBoatAPI.newTable()
        a = g_savedata.a
        a.b = LifeBoatAPI.newTable()
        a.c = a.b
        a.b.e = 123
        a.b.f = 234
    end
    ...
    if command == "?load" then
        LifeBoatAPI.Globals.Classes:load(g_savedata.a)
    end

    if command == "?test" or command == "?set" then

        server.announce("TEST a: ",     tostring(g_savedata.a))
        server.announce("TEST a.b: ",   tostring(g_savedata.a.b))
        server.announce("TEST a.c: ",   tostring(g_savedata.a.c))
        server.announce("TEST a.b.e: ", tostring(g_savedata.a.b.e))
        server.announce("TEST a.b.f: ", tostring(g_savedata.a.b.f))
        server.announce("TEST a.c.e: ", tostring(g_savedata.a.c.e))
        server.announce("TEST a.c.f: ", tostring(g_savedata.a.c.f))
    end
end